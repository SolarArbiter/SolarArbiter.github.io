...
The interactive map below shows the proposed climate zones. We invite stakeholder feedback on this map (email [info@solarforecastarbiter.org](mailto:info@solarforecastarbiter.org) or a team member).  Feedback will be incorporated through September 30, 2019. A <a href="{{ 'assets/climate_zones/SFA_Climate_Zones.kmz' | relative_url }}">KMZ file</a> of the regions is available.
