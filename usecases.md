...
1. Definitions
    1. Forecast run vs. Forecast vs. Forecasts
    2. Forecast parameters
    3. Users
2. Use Cases
    1. Evaluate forecasts
        1.A. Compare a forecast to measurements
        1.B. Compare a probabilistic forecast to measurements
        1.C. Compare multiple forecasts to measurements
        1.D. Compare forecasts to measurements for sites and aggregates
        1.E. Evaluate an event forecast
        1.F. Conduct forecast trial
        1.G. Compare multiple forecast runs to measurements (stretch)
    2. Analyze forecasts
        2.A. Select subsets of forecasts and data
        2.B. Identify events
        2.C. Find forecasts errors with large impacts (stretch)
3. Framework functional capabilities
    3. Perform forecast evaluation in a standard manner
        3.A. Calculate forecast error metrics
        3.B. Calculate forecast impacts (stretch)
        3.C. Communicate probabilistic forecasts
        3.D. Facilitate communication of forecasts and forecast metrics
    4. Administer the framework
        4.A. Manage users and organizations
        4.B. Manage data.
        4.C. Provide the framework API
        4.D. Provide reference forecasts
        4.E. Provide reference data
        4.F. Protect forecasts and data
        4.G. Perform data quality checks
    5. Archive data and forecasts
        5.A. Provide historical data, forecasts and forecast errors



# Definitions

## Forecast and Forecast runs
...
## Framework User and Framework Administrator
...
# Framework functional capabilities
...
### 3.B. Calculate forecast error impacts (stretch)
